-- ============================================
-- KOMPLETNA MIGRACIJA ZA MOA PROJEKAT
...
INSERT INTO users (email, ime, prezime, uloga) VALUES
  ('moa@mail.com', 'Admin', 'MOA', 'admin');

INSERT INTO establishments (naziv, adresa, grad, telefon, email, pib) VALUES
  ('PZU Poliklinika "Ministry of Aesthetics - MOA"', 'Ul Seika Zaida, The Capital Plaza', 'Podgorica', '+382 67/941-941', 'info@moa.clinic', '03706273');
...
INSERT INTO doctors (ime, prezime, specijalizacija, titula, boja) VALUES
  ('Sanja', 'Vujanovic', 'dermatovenerologija', 'Dr', '#2BA5A5');
...
INSERT INTO services (kategorija_id, naziv, cijena, trajanje) VALUES
  ...
  ((SELECT id FROM service_categories WHERE naziv = 'Laser tretmani'), 'Lasersko uklanjanje tetovaze', 100, 60),
  ((SELECT id FROM service_categories WHERE naziv = 'Laser tretmani'), 'Laser podmladjivanje', 180, 60);

INSERT INTO reminder_settings (enabled, timing, vrijeme) VALUES (false, 'dan_termina', '08:00');
